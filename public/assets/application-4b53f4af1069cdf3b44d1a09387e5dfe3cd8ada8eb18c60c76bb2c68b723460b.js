(() => {
  ...
  var LocationMapper = class {
    ...
    findContainerAndOffsetFromLocation(location) {
      ...
      if (nodeIsTextNode(node)) {
        if (nodeLength(node) === 0) {
          ...
          container = node;
          offset2 = location.offset - nodeOffset;
        }
      } else {
    ...
    findNodeAndOffsetFromLocation(location) {
      ...
      for (const currentNode of this.getSignificantNodesForIndex(location.index)) {
        ...
        if (location.offset <= offset2 + length) {
  ...
  var MutationObserver = class extends BasicObject {
    constructor(element) {
      super(element);
  ...
  var Controller = class extends BasicObject {
  };
  ...
  var EditorController = class extends Controller {
    constructor(_ref) {
      let {
        editorElement,
        document: document2,
  ...
  var DirectUploadController = class {
    ...
    start(callback) {
      ...
      this.dispatch("start");
      this.directUpload.create((error, attributes2) => {
        if (error) {
  ...
  var AttachmentUpload = class {
    ...
    directUploadDidComplete(error, attributes2) {
      if (error) {
...
/*!
  ...
  */
//# sourceMappingURL=/assets/application.js-50159b7f337f5fd3fc0efe0cf8ffa633c4048c289526f6a7c0769e26ce675810.map
//!
;
